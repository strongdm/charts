...
|-----------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------|----------|
| .autoRegisterCluster                    | Automatically register the hosting cluster as a resource in StrongDM.                                                                                                 | false                         | &#9744;  |
| .global.addDateLabel                    | Add a timestamp label to all Kubernetes resources.                                                                                                                    | true                          | &#9744;  |
